...
export default function Datatables({
  ...
  return (
    <UI.Stack spacing={2} flexGrow={1} overflow="auto" className="intro-listperkara" sx={tableSx}>
      ...
      <UI.Stack direction={"row"} justifyContent={"space-between"} spacing={2}>
      ...
      {data && (
        <RenderDetail
          data={data
            ...
            .slice((activePage - 1) * pagination?.perpage, (activePage - 1) * pagination.perpage + pagination.perpage)}
          col={col}
          order={order}
      ...
      <div style={{ minWidth: "200px", width: "100%" }}>
        ...
        <UI.Row
          ...
          sx={{
            ...
            // flexGrow: 1,
            minWidth: "100%",
            bgcolor: config?.bgcolor || "primary.main",
            height: 48,
          }}
        >
          {col.map((dx, ix) => (
          ...
          >
            {col.map((dx, dix) => (
              ...
              >
                ...
                >
                  {dx.type != "approval" && (
                    <UI.Row onClick={() => clickedRow(d.id)} flexGrow={1} height="100%" px={2} justifyContent={dx.align} alignItems="center">
