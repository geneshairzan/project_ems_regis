  ...
  return (
    <UI.Col spacing={2}>
      <UI.Row alignItems="center" spacing={1}>
        <UI.IconButton onClick={() => router.back()} name="home" color="white" />
          ...
          schema
            ...
            .map((d, ix) => (
              <React.Fragment key={ix}>
                {!Boolean(d.isList) && <DynamicFormRenderer formik={formik} d={{ ...d, ...modelInfo?.form?.[d.name] }} key={ix} name={d.name} />}
