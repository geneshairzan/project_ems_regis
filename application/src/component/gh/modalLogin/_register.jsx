  ...
  return (
    <UI.Col width="100%">
      <UI.Col center spacing={2}>
        ...
        <Form.Text type="password" label="password" fullWidth value={formik.values.password} name="password" onChange={formik.handleChange} />
        <Form.Text type="password" label="re-enter password" fullWidth value={formik.values.rpwd} name="rpwd" onChange={formik.handleChange} />
